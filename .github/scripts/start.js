...
async function startBrowser (browserName) {
  ...
  if (browserName === 'firefox') {
    const extension = await fs.readFile(path.join(__dirname, '..', '..', `hey_world_code_blocks_enhancer-firefox-v${pkg.version}.xpi`))
    await browser.installAddOn(extension.toString('base64'), true)
  }

  await browser.url('https://world.hey.com/jorge/globals-callbacks-and-other-sacrileges-d9832c35')
}
